<div class="border border-radius padding-two">
    <form method="POST" action="{{ route('auth.register') }}">
        ...
        <input type="number" name="id" placeholder="Please insert plutonium guid" class="width-100-percent border border-radius background-none padding-two box-sizing-border-box font-color font-weight-six-hundred font-family default-outline margin-top">
