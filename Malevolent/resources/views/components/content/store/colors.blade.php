<div class="border padding-two box-sizing-border-box border-radius margin-top grid grid-two-columns grid-gap">
    <div class="padding-seven background-color-six border-radius border">
        <div class="font-color font-weight-six-hundred">
            ...
            <a href="/discord/redirect" class="link border-none border-radius padding-two width-100-percent box-sizing-border-box background-color-six transition font-align-center font-size-two font-weight-six-hundred margin-top">Buy</a>
        </div>
    </div>
    <div class="padding-seven background-color-six border-radius border">
        <div class="font-color font-weight-six-hundred">
